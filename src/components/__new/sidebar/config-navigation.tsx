...
const ICONS = {
    ...
    search: icon('mingcute:search-3-line')
...
export const mobileConfig = {
    ...
    items: [
        // USER
        {
            ...
            icon: <Iconify width={25} icon="ph:shopping-cart-simple-bold" />,

        },
        {
            title: 'Search',
            path: PATH_DASHBOARD.user.root,
            icon: <Iconify width={25} icon="mingcute:search-3-line" />,
...

        {
            title: 'Profile',
            path: PATH_DASHBOARD.user.root,
            icon: <Iconify width={25} icon="ph:user-bold" />,
